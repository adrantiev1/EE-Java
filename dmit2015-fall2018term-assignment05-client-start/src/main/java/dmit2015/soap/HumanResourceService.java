 ...
 * 
 */
@WebServiceClient(name = "HumanResourceService", targetNamespace = "http://localhost/", wsdlLocation = "http://192.168.73.128:8080/dmit2015-fall2018term-assignment05-server-start/HumanResourceService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.73.128:8080/dmit2015-fall2018term-assignment05-server-start/HumanResourceService?wsdl");
